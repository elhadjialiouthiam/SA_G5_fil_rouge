 ...
 */
final class Version20200820003810 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD chat_general_id INT DEFAULT NULL, ADD brief_aprennant_id INT DEFAULT NULL, DROP roles');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:json)\', DROP chat_general_id, DROP brief_aprennant_id');
    }
}
