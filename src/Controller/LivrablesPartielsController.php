...
class LivrablesPartielsController extends AbstractController
{
     ...
     * )
     */
    public function putLivrablePartielByFormateur( Request $request, $id_promo, $id_brief,EntityManagerInterface $manager, PromosRepository $promoRepository, BriefPromoRepository $briefPromoRepository, GroupeRepository $repoGroupe, LivrablesPartielsRepository $livrablePartielRepository, SerializerInterface $serializer)
    {
        ...
        if (empty($data['dateLivraison'])) {
            return new JsonResponse('La date de livraison est requise.', Response::HTTP_BAD_REQUEST, [], true);
        }
        ...
        $livrablePartiel->setcreatedAt(new \DateTime());
